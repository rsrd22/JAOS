...
import Vistas.VentanaConsultarArticulo;
 ...
 * @author User
 */
public class ventanaBusquedaArticulo extends javax.swing.JFrame {
    ...
    public VentanaConsultarArticulo vca;
    private int x, y;
     ...
     */
    public ventanaBusquedaArticulo() {
        initComponents();
        Utilidades.EstablecerIcono(this);
        modelo = new DefaultTableModel();
        this.setLocationRelativeTo(null);
        ccon = new ControlConcepto();
        vca = new VentanaConsultarArticulo();

        String[] nombreColumnas = new String[8];
        nombreColumnas = new String[]{"Codigo", "Nombre", "Valor"};
        int filas = 0;

    }

    public ventanaBusquedaArticulo(VentanaConsultarArticulo vca) {
    ...
    private void LlenarListaDatos(){
        ...
        SQL = "SELECT `pk_articulo` CODIGO ,`nombre` NOMBRE ,`valor` VALOR  FROM articulo\n ORDER BY NOMBRE ASC";
    ...
    private void initComponents() {
        ...
        btnRegistroInicial.setBorder(null);
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 150, 480, 230));
        ...
        jLabel2.setText("a");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 120, 10, -1));

        lblFin.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        lblFin.setForeground(new java.awt.Color(21, 67, 96));
        lblFin.setText("10");
        jPanel1.add(lblFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 120, 40, -1));
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 0, 30, 30));
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 0, 30, 30));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, 31));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 100, 120, 40));
...
//                    vca = new VentanaConsultarArticulo();
                    ...
                    vca.lblcodArticulo.setText(""+modAux.getValueAt(filaSeleccionada, 0));
                    System.out.println("lo que trae ----"+""+ modAux.getValueAt(filaSeleccionada, 0));
                    vca.txtNombreArticulo.setText(""+ modAux.getValueAt(filaSeleccionada, 1));
                    System.out.println("lo que trae ----"+""+ modAux.getValueAt(filaSeleccionada, 1));
                    vca.txtValorArticulo.setText(""+modAux.getValueAt(filaSeleccionada, 2));
                    
                    System.out.println("si selecciona");
                    vca.btnCrearArticulo.setEnabled(false);
...
//                    vca = new VentanaConsultarArticulo();
                    ...
                    vca.lblcodArticulo.setText(""+ modAux.getValueAt(filaSeleccionada, 0));
                     System.out.println("dddddd------"+modAux.getValueAt(filaSeleccionada, 0));
                    vca.txtNombreArticulo.setText(""+ modAux.getValueAt(filaSeleccionada, 1));
                     System.out.println("dddddd------"+modAux.getValueAt(filaSeleccionada, 1));
                    vca.txtValorArticulo.setText(""+modAux.getValueAt(filaSeleccionada, 2));
                     System.out.println("dddddd------"+modAux.getValueAt(filaSeleccionada, 2));
                    
                     System.out.println("si selecciona con el mouse");
                    vca.btnCrearArticulo.setEnabled(false);
...
//                            break;
    ...
    private void jLabel6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel6MouseClicked
        this.setState(ventanaBusquedaArticulo.ICONIFIED);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventanaBusquedaArticulo(null).setVisible(true);
            }
        });
    }
...
//            }
            if (!SQL.equals("")) {
                ...
                if (rs.next()) {
                    ...
                    JOptionPane.showMessageDialog(null, "No se encontraron datos");// con el mensade de confirmacion mandar a cerrar la ventana de busqueda
                      this.dispose();
