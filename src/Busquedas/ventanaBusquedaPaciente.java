 ...
 * @author User
 */
public class ventanaBusquedaPaciente extends javax.swing.JFrame {
    ...
    public ventanaBusquedaPaciente(int opc, String DatosSalida, String estadoch, VentanaCitas vc) {
    ...
    public ventanaBusquedaPaciente(int opc, String DatosSalida, String estadoch, VistaPaciente vp) {
    ...
    private void LlenarListaDatos(){
        ...
        SQL = "SELECT CONCAT(per.pfk_tipo_documento, per.pk_persona) IDENTIFICACION, \n"
                + "CONCAT_WS(' ', per.primer_apellido, IFNULL(per.segundo_apellido, ''), per.primer_nombre, IFNULL(per.segundo_nombre, '')) NOMBRE, IFNULL(per.correo_electronico, '') EMAIL,\n"
                + "REPLACE(GROUP_CONCAT(IFNULL(tel.numero, '')), ',', '-') TELEFONO, 'P' TIPO\n"
                + "FROM `pacientes` pac\n"
                + "INNER JOIN `personas` per ON CONCAT(per.pfk_tipo_documento, per.pk_persona) = pac.pfk_paciente\n"
                + "LEFT JOIN `personas_telefonos` tel ON tel.pfk_persona=CONCAT(per.pk_persona) GROUP BY pac.pfk_paciente\n"
                + "UNION\n"
                + "SELECT IFNULL(paux.pk_paciente_auxiliar, '') IDENTIFICACION, \n"
                + "CONCAT_WS( ' ', paux.primer_apellido, IFNULL(paux.segundo_apellido, ''), paux.primer_nombre, IFNULL(paux.segundo_nombre, '')) NOMBRE, IFNULL(paux.email, '') EMAIL,\n"
    ...
    private void initComponents() {
        ...
        jPanel1.add(txtFiltro, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 260, 30));
        ...
        jPanel1.add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 70, 30, 30));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 159, 590, 240));
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 0, 30, 30));
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 0, 30, 30));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 620, 31));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, 260, 10));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 110, 140, 40));
        ...
        try {
            ...
            if (DatosSalida != null) {
                ...
                if (filaSeleccionada > -1) {
                    ...
                    if (opc == 1) {////////////CITAS
                        vc.lblIdentificacion.setText(fila.get(0));
                        vc.txtNombre.setText(fila.get(1));
                        vc.ConsultarCitas();
                        vc.banBQDPac = 0;
                        this.dispose();
                    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaBusquedaPaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void cargarDatosTabla(String[] nombreColumnas, ArrayList<String[]> datos) {
        ...
        tblDatos.getColumnModel().getColumn(0).setPreferredWidth(90);
    ...
    private void GenerarTablaOLD() {
        try {
            ...
            String add = "WHERE CONCAT_WS(' ',LOWER(IDENTIFICACION), LOWER(NOMBRE), LOWER(EMAIL), LOWER(TELEFONO)) LIKE '%" + filtro + "%' ";

            SQL = "SELECT CONCAT(per.pfk_tipo_documento, per.pk_persona) IDENTIFICACION, CONCAT_WS(' ', per.primer_nombre, IFNULL(per.segundo_nombre, ''), per.primer_apellido, IFNULL(per.segundo_apellido, '')) NOMBRE, IFNULL(per.correo_electronico, '') EMAIL,\n"
                    + "REPLACE(GROUP_CONCAT(IFNULL(tel.numero, '')), ',', '-') TELEFONO, 'P' TIPO\n"
                    + "FROM `pacientes` pac\n"
                    + "INNER JOIN `personas` per ON CONCAT(per.pfk_tipo_documento, per.pk_persona) = pac.pfk_paciente\n"
                    ...
                    + "UNION\n"
                    + "SELECT IFNULL(paux.pk_paciente_auxiliar, '') IDENTIFICACION, CONCAT_WS( ' ', paux.primer_nombre, IFNULL(paux.segundo_nombre, ''), paux.primer_apellido, IFNULL(paux.segundo_apellido, '')) NOMBRE, IFNULL(paux.email, '') EMAIL,\n"
                    + "IFNULL(paux.telefono, '') TELEFONO, paux.tipo TIPO\n"
                    + "FROM  `paciente_auxiliar` paux WHERE estado = 'ACTIVO'\nORDER BY IDENTIFICACION ASC";
            SQL = "SELECT CONCAT(per.pfk_tipo_documento, per.pk_persona) IDENTIFICACION, \n"
                    + "CONCAT_WS(' ', per.primer_apellido, IFNULL(per.segundo_apellido, ''), per.primer_nombre, IFNULL(per.segundo_nombre, '')) NOMBRE, IFNULL(per.correo_electronico, '') EMAIL,\n"
