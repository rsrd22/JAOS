 ...
 * @author User
 */
public class ventanaBusquedaPerfil extends javax.swing.JFrame {
     ...
     */
    public ventanaBusquedaPerfil(){
        initComponents();
    }
    public ventanaBusquedaPerfil(int opc, String DatosSalida, String estadoch, VentanaUsuarios vu) {
        initComponents();
    ...
    private void LlenarListaDatos(){
        ...
        SQL = "SELECT pk_perfil AS IDPERFIL, perfil AS PERFIL\n" +
                    "FROM `perfiles`\nORDER BY PERFIL ASC";
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 159, 501, 260));

        lblIni.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        lblIni.setForeground(new java.awt.Color(21, 67, 96));
        lblIni.setText("1");
        jPanel1.add(lblIni, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 120, 30, -1));
        ...
        lblFin.setText("10");
        jPanel1.add(lblFin, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 120, 30, -1));
        ...
        lblTotal.setText("10");
        jPanel1.add(lblTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 120, 40, -1));
        ...
        jLabel4.setText("Consulta de Perfiles");
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 100, 150, 40));
        ...
        try {
            ...
            if (DatosSalida != null) {
                ...
                if (filaSeleccionada > -1) {
                    ...
                    if(opc == 1){////////////CITAS
                        vu.lblPerfil.setText(fila.get(0));  
                        vu.txtPerfil.setText(fila.get(1));  
                        this.dispose();    
                    }
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaBusquedaPerfil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void GenerarTablaOLD() {
        try {
            ...
            String add  ="WHERE CONCAT_WS(' ',LOWER(IDPERFIL), LOWER(PERFIL)) LIKE '%"+filtro+"%' ";
