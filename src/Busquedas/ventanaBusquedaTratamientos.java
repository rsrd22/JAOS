...
import Vistas.VentanaCotizaciones;
import Vistas.VentanaPacienteAux;
import Vistas.VentanaModificarTrata;
 ...
 * @author User
 */
public class ventanaBusquedaTratamientos extends javax.swing.JFrame {
    ...
    public VentanaPacienteAux vpx;
    public VentanaCotizaciones vcot;
    public VentanaModificarTrata vmt;
    public int banest = 0;
    private int x, y;
     ...
     */
    public ventanaBusquedaTratamientos(){

    }
    public ventanaBusquedaTratamientos(int opc, String DatosSalida, String estadoch, VistaPaciente vp) {
        initComponents();
    ...
    public ventanaBusquedaTratamientos(int opc, String DatosSalida, String estadoch, VentanaPacienteAux vpx, int banest) {
        initComponents();
        Utilidades.EstablecerIcono(this);
        gsql = new gestorMySQL();
        this.opc = opc;
    ...
    public ventanaBusquedaTratamientos(int opc, String DatosSalida, String estadoch, VentanaCotizaciones vcot, int banest) {
        initComponents();
        Utilidades.EstablecerIcono(this);
        gsql = new gestorMySQL();
        this.opc = opc;
     ...
     public ventanaBusquedaTratamientos(int opc, String DatosSalida, String estadoch, VentanaModificarTrata vmt, int banest) {
        initComponents();
        Utilidades.EstablecerIcono(this);
        gsql = new gestorMySQL();
        this.opc = opc;
    ...
    private void LlenarListaDatos(){
        ...
        SQL = "SELECT pk_tratamiento ID , descripcion TRATAMIENTO\n" +
                "FROM `tratamientos` tra WHERE tra.`estado` = 'Activo'\n" +
                "GROUP BY tra.`pk_tratamiento`\nORDER BY TRATAMIENTO ASC";
    ...
    private void initComponents() {
        ...
        setTitle("Busqueda Tratamientos");
        ...
        jPanel1.add(txtFiltro, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, 260, 30));
        ...
        jPanel1.add(btnBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 60, 30, 30));
        ...
        jLabel4.setText("Consulta de Tratamientos");
        ...
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 90, 260, 10));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 100, 140, 40));
    ...
    public void SeleccionarFilaCot(){
        int filaSeleccionada;
        ArrayList<String> fila = new ArrayList<>();
        try {
            filaSeleccionada = tblDatos.getSelectedRow();
            ...
            if (DatosSalida != null) {
                ...
                if (filaSeleccionada > -1) {
                    ...
                    if(opc == 1){////////////CITAS
                        ...
                        datos[0] = fila.get(0);
                        datos[1] = fila.get(1);
                        vcot.lblIdTratamiento.setText(""+fila.get(0));
                        vcot.txtTratamiento.setText(""+fila.get(1));
                        vcot.banBQDTrat = 0;
                        vcot.txtCostoTotal.requestFocus();
                        this.dispose(); 
                    }
                } else {
                    JOptionPane.showMessageDialog(null, "No ha seleccionado ninguna fila");
    ...
    public void SeleccionarFilaAux(){
        int filaSeleccionada;
        ArrayList<String> fila = new ArrayList<>();
        try {
            filaSeleccionada = tblDatos.getSelectedRow();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaBusquedaTratamientos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventanaBusquedaTratamientos();
            }
        });
    }
    ...
    private void GenerarTablaOLD() {
        try {
            ...
            String add  ="WHERE CONCAT_WS(' ',LOWER(ID),LOWER(TRATAMIENTO)) LIKE '%"+filtro+"%' ";
            ...
            if (!SQL.equals("")) {
                ...
                if (rs.next()) {
                    ...
                    for (int j = 1; j <= rsmd.getColumnCount(); j++) {
                        Columnas[j - 1] = rsmd.getColumnName(j).replace("_", " ");
                    }
                    NameColumnas = Columnas;
                    do {
                        tot++;
