 ...
 * @author User
 */
public class ventanaBusquedaUsuario extends javax.swing.JFrame {
     ...
     */
    public ventanaBusquedaUsuario(){

    }
    public ventanaBusquedaUsuario(int opc, String DatosSalida, String estadoch, VentanaUsuarios vu) {
        initComponents();
    ...
    private void LlenarListaDatos(){
        ...
        SQL = "SELECT us.`pk_usuario` AS USUARIO,\n" +
                ...
                "ORDER BY CAST(us.`fk_perfil` AS UNSIGNED) ASC, USUARIO ASC";
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 159, 501, 230));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 110, 130, 40));
        ...
        try {
            ...
            if (DatosSalida != null) {
                ...
                if (filaSeleccionada > -1) {
                    ...
                    if(opc == 1){////////////CITAS
                        vu.txtUsuario.setText(fila.get(0));  
                        vu.ConsultarUsuarios();
                        this.dispose();    
                    }
                } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaBusquedaUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private void GenerarTablaOLD() {
        try {
            ...
            String add  ="WHERE CONCAT_WS(' ',LOWER(USUARIO), LOWER(NOMBRE), LOWER(PERFIL)) LIKE '%"+filtro+"%' ";
