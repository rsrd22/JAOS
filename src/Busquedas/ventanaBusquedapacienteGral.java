...
public class ventanaBusquedapacienteGral extends javax.swing.JFrame {
...
//    public int registrosIniciales, registrosTotales, registrosInicialPag, registrosFinalPag;
    ...
    public ventanaBusquedapacienteGral() {
        initComponents();
    ...
    public ventanaBusquedapacienteGral(ventana venRef, String estado) {
        initComponents();
        Utilidades.EstablecerIcono(this);
    ...
    private void LlenarListaDatos(){        
        SQL = "SELECT CONCAT(per.pfk_tipo_documento, per.pk_persona) TID, per.primer_nombre PNOMBRE, per.segundo_nombre SNOMBRE, \n"
                + "per.primer_apellido PAPELLIDO, per.segundo_apellido SAPELLIDO,\n"
                + "'P' TIPO\n"
                + "FROM `pacientes` pac\n"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaBusquedapacienteGral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventanaBusquedapacienteGral(null, null).setVisible(true);
            }
        });
    }
    ...
    private void selectRow() {
        ...
        try {
            ...
            if (filaSeleccionada > -1) {
                ...
                venHC.band = 0;
                venHC.tipoPaciente = (String) modAux.getValueAt(filaSeleccionada, 5);

                if (!Expresiones.ValidarTipoPacienteAO((String) modAux.getValueAt(filaSeleccionada, 5))) {

                    setDocumentoTipoDoc((String) modAux.getValueAt(filaSeleccionada, 0));
        ...
        if (venHC.tipoPaciente.equalsIgnoreCase("p")) {
            ...
            venHC.setEstadosBotonesDeControl(1);
        }
