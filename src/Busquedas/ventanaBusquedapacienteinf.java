 ...
 * @author User
 */
public class ventanaBusquedapacienteinf extends javax.swing.JFrame {
     ...
     */
    public ventanaBusquedapacienteinf() {
        initComponents();
    ...
    public ventanaBusquedapacienteinf(VentanaInformes vin) {
    ...
    private void LlenarListaDatos(){        
        SQL = "SELECT CONCAT(per.pfk_tipo_documento, per.pk_persona) TID, \n"
            + "CONCAT_WS(' ', per.primer_nombre, IFNULL(per.segundo_nombre, ''), per.primer_apellido, IFNULL(per.segundo_apellido, '')) NOMBRE, IFNULL(per.correo_electronico, '') EMAIL,\n"
            ...
            + "                   UNION\n"
            + "	           SELECT IFNULL(paux.pk_paciente_auxiliar, '') TID, \n"
            + "		   CONCAT_WS(' ', paux.primer_nombre, IFNULL(paux.segundo_nombre, ''), paux.primer_apellido, IFNULL(paux.segundo_apellido, '')) NOMBRE, IFNULL(paux.email, '') EMAIL,\n"
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 159, 570, 230));
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 0, 30, 30));
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 0, 30, 30));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 610, 31));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 110, 130, 40));
...
//                    fila.add((String)modAux.getValueAt(filaSeleccionada, 1));
                vin.lblIdPaciente.setText((String) modAux.getValueAt(filaSeleccionada, 0));
                vin.txtPaciente.setText((String) modAux.getValueAt(filaSeleccionada, 1));
//                    vin.mostrarcampos(true);
