 ...
 * @author Acer
 */
public class InformespdfFactura extends PdfPageEventHelper{
    ...
    public static final Font font13n = FontFactory.getFont(FontFactory.HELVETICA_BOLD, 13);
...
//Monotype Corsiva
    ...
    public static String pieFechaHora = "";
...
//    public InformespdfFactura(PdfPTable encabezado) {
//
//        if(con==0){
...
////                }
////
////                table.setWidths(new int[]{22, 21, 6});
...
////                table.addCell(celda);
////
////                celda = new PdfPCell(new Phrase("pieFecha Hora", font4));
////                celda.setHorizontalAlignment(Element.ALIGN_RIGHT);
////                celda.setVerticalAlignment(Element.ALIGN_MIDDLE);
////                celda.setBorder(0);
////                //table.addCell(celda);
